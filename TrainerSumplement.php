...
<head>
	<title>Trainer Sumplement</title>
	<!-- Meta tag Keywords -->
		...
		<div class="modal-dialog">
		  <div class="modal-content">
			...
			<div class="modal-header">
			  <h4 class="modal-title">Sumplement</h4>
			...
			<div class="modal-body">
				<div>
					...
					<div class="form-group">
						<label >Name of Sumplement</label>
						<input type="text" placeholder="Name of supplements" class="form-control" />
					</div>
					<div class="form-group">
